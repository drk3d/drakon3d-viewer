// cloud/config.example.js — template for cloud/config.js.
//
// SETUP:
//   1. Copy this file to cloud/config.js (which is gitignored).
//   2. Fill in the values below from each provider's console.
//   3. Make sure each provider has your domain registered as the
